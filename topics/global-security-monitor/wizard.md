# Topic Wizard Answers

1. **What decision or situational-awareness need should this topic support?**
   - Maintain a neutral daily read on public global-security developments and identify what materially changed since the last briefing.

2. **What is the ideal briefing length: 3 bullets, 1 paragraph, or deeper analysis?**
   - 3 to 5 concise bullets, with deeper analysis only when a development changes the risk picture or near-term watch priorities.

3. **Which public sources or source categories do you trust most?**
   - Official public statements, reputable wire services, established international/local reporting, and specialist public-source analysts who cite methods and sources.

4. **Which sources are useful but need caution or corroboration?**
   - Fast-moving social posts, single-source local reports, translated summaries, aggregation accounts, and specialist analysis that depends on inference.
...
8. **What should be ignored as noise?**
   - Viral repetition without new sourcing, graphic or sensational posts, single-source claims presented as fact, recycled media, broad speculation, and commentary that does not add verifiable information.
...
12. **What confidence language should the briefing use for unconfirmed or disputed claims?**
    - Use confirmed, reported, claimed, unverified, disputed, or unclear. Do not imply certainty when the sourcing does not support it.
